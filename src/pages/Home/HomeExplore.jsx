                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-5">
                        {cities.map((city, index) => {
                            return (
                                ...
                                >
                                    <Link
                                        to={`/resturants/${city.name}`}
                                        className="w-full h-full relative group"
                                    >
                                        <img
                                            src={city.image}
                                            alt={city.image}
                                            className="transition-transform duration-300 ease-linear rounded-lg object-cover w-full h-full group-hover:scale-[1.06]"
                                        />
                                        ...
                                        <div className="bottom-3 left-3 absolute hidden group-hover:block">
                                            <h1 className="text-red-500 font-extrabold text-9xl">
                                                {city.name.charAt(0)}
                                            </h1>
                                        </div>
                                    </Link>
