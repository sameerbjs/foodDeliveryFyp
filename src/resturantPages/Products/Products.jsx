        ...
        <>
            ...
            <div className="container px-5 py-7 mx-auto overflow-hidden">
                <div className='flex justify-between items-center flex-wrap gap-3'>
                    <h1 className='lg:text-2xl md:text-xl text-lg font-semibold text-[#212245]'>Here is your all products</h1>
                    ...
                    <table className="min-w-full divide-y divide-gray-300 text-left">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className='flex gap-2 items-center'>
                                                        <Link to={`/edit-pro/${item._id}`} className='border px-2 py-1 hover:bg-slate-200/60'>Edit</Link>
                                                        <Link to={`/pro-view/${item._id}`} className='border px-2 py-1 hover:bg-slate-200/60'>View</Link>
                                                        <button onClick={() => handleDeleteModel(item._id)} className='border px-2 py-1 hover:bg-slate-200/60'>Delete</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </>
                            ...
                            }
                            {
                                ...
                                <tr>
                                    <td className="px-6 py-4 text-center" colSpan='100%'>
                                        <button className="bg-red-500 hover:bg-[#212245] text-white fs-14 px-3 py-2 rounded-lg shadow-md" onClick={handleLoadMore}>Load More</button>
                                    </td>
                                </tr>
                            }
                        </tbody>
            ...
            <DeleteProductModel isOpen={isOpen} setIsOpen={setIsOpen} handleDeleteProduct={handleDeleteProduct} />
        </>
    )
}
